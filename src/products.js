...
{
    id: 16, stock: 30, title: 'Organizador para bolsos', description: 'Organizador para bolsos, mochilas y carteras, muy práctico para trasladar tus cosas!', price: 350.0, pictureUrl: 'organizador-bolsos.jpg', idCategory: 6
},
{
    id: 17, stock: 30, title: 'Almohada para viaje', description: 'Para dormir con comodidad en tus viaje. Con antifaz de regalo!', price: 300.0, pictureUrl: 'almohada-viaje.jpg', idCategory: 6
},
{
    id: 18, stock: 30, title: 'Identificador de valija', description: 'Identificador para valija de gatito!', price: 150.0, pictureUrl: 'identificador-valija.jpg', idCategory: 6
}
    ,
{
    id: 19, stock: 30, title: 'Set de limas x3', description: 'Set de 3 limas de diferentes estilos!', price: 150.0, pictureUrl: 'set-limas.jpg', idCategory: 7
},
{
    id: 20, stock: 30, title: 'Bálsamo labial frutilla', description: 'Bálsamo labial con sabor a frutilla', price: 200.0, pictureUrl: 'balsamo-frutilla.jpg', idCategory: 7
},
{
    id: 21, stock: 30, title: 'Espuma de baño', description: 'Espuma de baño para disfrutar en la ducha!', price: 250.0, pictureUrl: 'espuma-baño.jpg', idCategory: 7
},
{
    id: 22, stock: 30, title: 'Lapicera frutas set x5', description: 'Set de 5 lapiceras!', price: 250.0, pictureUrl: 'lapicera-frutas.jpg', idCategory: 8
},
{
    id: 23, stock: 30, title: 'Cuaderno glitter', description: 'Para realizar tus anotaciones', price: 200.0, pictureUrl: 'cuaderno-glitter.jpg', idCategory: 8
},
{
    id: 24, stock: 30, title: 'Resaltadores de colores', description: 'Resaltadores de diferentes colores, set x6!', price: 300.0, pictureUrl: 'resaltadores-colores.jpg', idCategory: 8
}
];
